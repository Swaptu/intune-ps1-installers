# ============================================================
# Update-7zip.ps1
# Intune-deployed script — silently upgrades 7-Zip
# Logs to: C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\
# ============================================================

$LogFile = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\Update-7zip.log"
...
try {
    ...
    Write-Log "====== Update-7zip finished ======"
    exit ($anyFailed ? 1 : 0)
}
catch {
    Write-Log "====== Update-7zip FAILED: $_ ======" -Level ERROR
    exit 1
}
