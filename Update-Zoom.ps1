# ============================================================
# Update-Zoom.ps1
# Intune-deployed script — silently upgrades Zoom
# Logs to: C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\
# ============================================================

$LogFile = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\Update-Zoom.log"
...
try {
    ...
    Write-Log "====== Update-Zoom finished ======"
    exit ($anyFailed ? 1 : 0)
}
catch {
    Write-Log "====== Update-Zoom FAILED: $_ ======" -Level ERROR
    exit 1
}